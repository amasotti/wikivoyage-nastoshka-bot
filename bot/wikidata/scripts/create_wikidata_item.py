...
class WikidataDestinationImporter():
    ...
    def edit_opts(self) -> dict[str, Any]:
        return {"summary": "Imported from it.wikivoyage",
                "watch": "watch"
                }
    ...
    def create_items(self):
        for item in self.generator:
            ...
            new_item.editDescriptions(item['descriptions'], summary='Setting description')
    ...
    def handle_coords(self, item: ItemPage, data):
        ...
        coords = pywikibot.Coordinate(lat=lat, lon=lon, precision=0.0001, site=self.repo)
    ...
    def handle_administrative_entity(self, item: ItemPage, claims: dict):
        ...
        claim.setTarget(pywikibot.ItemPage(self.repo, claims['administrative_entity']['target']))
        claim.addSource(self.set_qualifier())
    ...
    def handle_body_of_water(self, item: ItemPage, claims: dict):
        ...
        claim.setTarget(pywikibot.ItemPage(self.repo, claims['body_of_water']['target']))
        claim.addSource(self.set_qualifier())
